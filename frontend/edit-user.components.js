...
export default class EditUser extends Component {
    ...
    axios
      ...
      .then((response) => {
        this.setState({
          ...
          user_addy1: response.data.user_addy1,
          user_addy2: response.data.user_addy2,
          user_city: response.data.user_city,
          user_zipcode: response.data.user_zipcode,
  ...
  onSubmit(e) {
    ...
    axios
      .post(
        "http://localhost:4000/user/update/" + this.props.match.params.id,
        obj
      )
